...
required_files=(
  ...
  "src/agentops_control_tower/display_paths.py"
  "src/agentops_control_tower/errors.py"
  "src/agentops_control_tower/html_reporting.py"
